-- Mage Craft Database Schema for Supabase (FIXED VERSION)
-- Generated: 2025-01-27
-- Purpose: Complete database schema for prompt management MVP
-- Fixed: Removed trigger on auth.users that requires superuser privileges
...
-- =====================================================
-- IMPORTANT: Manual Profile Creation Setup Required
-- =====================================================
-- 
-- Since we cannot create a trigger on auth.users directly, you have TWO OPTIONS:
--
...
--    - HTTP Headers: Add Authorization header with a secret token
--
-- Then create the webhook handler in your app at:
-- app/api/webhooks/create-profile/route.ts
--
-- OPTION 2: Application-Level Profile Creation
-- -------------------------------------------
-- Handle profile creation in your app after user signup:
-- 
...
-- Uncomment these lines after you have created your first user profile
-- 
-- INSERT INTO public.folders (user_id, name, description, color) VALUES
--   ('your-user-id-here', 'Work Projects', 'Professional prompt templates', 'blue'),
--   ('your-user-id-here', 'Creative Writing', 'Story and content creation prompts', 'purple'),
--   ('your-user-id-here', 'Code Generation', 'Programming assistance prompts', 'green');
